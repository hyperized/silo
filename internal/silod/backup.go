...
func newBackupSubsystem(cfg *config.Config, store chunkstore.Store, ns backup.NamespaceSnapshot, logger *slog.Logger) (*backup.Subsystem, error) {
	...
	exporter := backup.NewExporter(chunks, ns, cfg.NodeID)
